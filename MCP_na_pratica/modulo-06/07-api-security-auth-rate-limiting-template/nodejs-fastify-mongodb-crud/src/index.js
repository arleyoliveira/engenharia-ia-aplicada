...
const { role, serviceToken } = authResponse.json()
console.log(serviceToken)

let createCustomerResponse = await fastify.inject({
    method: 'POST',
    url: `/v1/customers`,
    headers: {
...
console.log(' createCustomerResponse ', createCustomerResponse.json())