...
export const server = new McpServer({
    name: '@arleymota/ciphersuite-mcp',
    version: '1.0.0',
})
...
server.registerTool(
    'encrypt_message',
    {
        ...
        inputSchema: {
            message: z.string().describe('The message to be encrypted'),
        ...
        messages: [
            {
                ...
                content: {
                    type: 'text',
                    text: `Please encrypt the following message using the encrypt_message_prompt tool.\nMessage: ${message}\nEncryption key: ${encryptionKey}`,
                }
            }
        ]
    }))