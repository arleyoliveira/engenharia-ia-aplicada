...
(async function main() {
    ...
    elements.temperatureValue.textContent = defaultTemperature;
    elements.temperature.max = maxTemperature;
    elements.temperature.min = 0;
    elements.temperature.value = defaultTemperature;
