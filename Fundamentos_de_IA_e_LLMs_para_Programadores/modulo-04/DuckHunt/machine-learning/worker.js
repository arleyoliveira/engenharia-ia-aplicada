...
/**
 * Pré-processa a imagem para o formato aceito pelo o YOLO:
 * - tf.browser.fromPixels(): converte ImageBitmap/ImagemData para tensor [H, W, 3]
 ...
 *   evintando vazamento de memória
 * @param {*} input 
 * @returns 
 */
